...
public class Driver {
	public static void main(String[] args) throws IOException {
		ArrayList<Store> stores = readInAll();
		addNew(stores);
		writeOutAll(stores);
	}

	public static ArrayList<Store> readInAll() throws FileNotFoundException {
	...
	public static void addNew(ArrayList<Store> stores) {
	...
	public static Store findStore(ArrayList<Store> stores) {
		...
		while(index == -1) {
			...
			System.out.println("To search again, type -1.");
			try {
				index = Integer.parseInt(scan.nextLine());
			} catch (Exception e) {
				System.out.println("No valid input detected, please try again.");
	...
	public static void writeOutAll(ArrayList<Store> stores) throws IOException {
